...
public class CriarConsultaModel {
    private final IntegerProperty processo;
    ...
    public CriarConsultaModel(){
        this.processo = new SimpleIntegerProperty();
    ...
    public IntegerProperty processoProperty() {
        return processo;
    }
